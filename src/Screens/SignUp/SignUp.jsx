      ...
      <MainContainer >
        ...
        <FlexItem>
          <FormSignUp>
            ...
            <Input placeholder='Nome completo' placeholderTextColor='white' color='white'/>
            ...
            <Input placeholder='Confirme a sua senha' secureTextEntry={true} password={true} placeholderTextColor='white' color='white'/>
